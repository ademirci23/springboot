...
-- Pour ajouter des lignes par la suite avec POST sinon H2 ne sait pas savoir ou se trouve l'IDENTITY
ALTER TABLE ETUDIANT ALTER COLUMN ID RESTART WITH 11;
ALTER TABLE UE ALTER COLUMN ID RESTART WITH 4;
ALTER TABLE MATIERE ALTER COLUMN ID RESTART WITH 11;
ALTER TABLE NOTE ALTER COLUMN ID RESTART WITH 31;
ALTER TABLE ETUDIANT ALTER COLUMN ID RESTART WITH 11;